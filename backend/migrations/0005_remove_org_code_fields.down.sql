ALTER TABLE organizations RENAME TO organizations_new;
ALTER TABLE departments RENAME TO departments_new;
...
INSERT INTO organizations (
    id, org_code, org_name, org_type, parent_id, leader_id, sort_order, status,
...
INSERT INTO departments (
    id, dept_code, dept_name, organization_id, parent_dept_id, leader_id, sort_order,
    status, created_by, created_at, updated_by, updated_at, deleted_at
)
SELECT
    id,
    'DEPT_' || id,
...
INSERT INTO employees (
    id, emp_code, emp_name, organization_id, department_id, position_level_id, position_title,
