...
func New(cfg config.Config, db *gorm.DB) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		votes.POST("/tasks/generate", middleware.RequirePermission("score:update"), voteHandler.GenerateVoteTasks)
		votes.GET("/tasks", middleware.RequirePermission("score:view"), voteHandler.ListVoteTasks)
		votes.POST("/tasks/:id/draft", middleware.RequirePermission("score:update"), voteHandler.SaveVoteDraft)
		votes.POST("/tasks/:id/submit", middleware.RequirePermission("score:update"), voteHandler.SubmitVote)
